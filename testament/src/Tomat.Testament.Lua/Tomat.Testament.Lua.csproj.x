<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <ProjectReference Include="../Tomat.Testament.API/Tomat.Testament.API.csproj" />
  </ItemGroup>
  ...
  <PropertyGroup>
    <NativeBinDir>../bin/$(Configuration)</NativeBinDir>
    <NativeOutputName>Lua5.3.3r</NativeOutputName>
  ...
  <ItemGroup>
    <NativeSource Include="dllmain.cpp" />
